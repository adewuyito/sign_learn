...
Size buttonSize(ButtonSize size) => switch (size) {
      ButtonSize.full => Size(398.dx, 62.dy),
      ButtonSize.half => Size(166.dx, 62.dy)
    };
...
class Dims {
  ...
  // Returns the available width of the device after subtracting horizontal padding
  static double get availableWidth => deviceSize.width - (padding.dx * 2);
